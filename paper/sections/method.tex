...
\begin{tikzpicture}[
    ...
    redinput/.style={draw=orange!70!black, fill=orange!8, rounded corners=4pt,
        minimum height=1cm, text=orange!70!black, font=\small, align=center},
    redmodel/.style={draw=orange!70!black, fill=orange!20, rounded corners=4pt,
        minimum height=1.2cm, text=orange!70!black, font=\small, align=center,
        line width=0.8pt},
    % Merge styles
    ...
    orangearrow/.style={-{Stealth[length=5pt]}, orange!70!black, line width=0.7pt},
...
\draw[orangearrow] (hmm) -- node[above, font=\tiny, text=orange!70!black, yshift=2pt, align=center, scale=0.85]
...
\node[font=\footnotesize\bfseries, text=orange!70!black, anchor=west]
...
\draw[bluearrow] (pick.south east) -- node[pos=0.4, above right, font=\scriptsize\itshape, text=blue!70!black] {$c$} ([yshift=3pt]cs.north west);
% Orange: sigma -> straight diagonal to combined score
\draw[orangearrow] (sigma.north east) -- node[pos=0.4, below right, font=\scriptsize\itshape, text=orange!70!black] {$1 {-} \gamma \cdot \sigma_t$} ([yshift=-3pt]cs.south west);
% ===================== DECISION =====================
