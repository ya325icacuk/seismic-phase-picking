...
\begin{tikzpicture}[
    ...
    scorebox/.style={draw=orange!80!black, fill=yellow!15, rounded corners=3pt,
        minimum height=1.4cm, minimum width=4.2cm, font=\small, align=center,
        line width=0.8pt},
...
\node[redmodel, minimum width=2.6cm] (hmm) at (3.8, -1)
    {\textbf{HMM}\\[-2pt]
