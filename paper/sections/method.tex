...
\draw[bluearrow] (pick.east) -- (pick.east -| cs.north) node[pos=0.6, right, font=\scriptsize\itshape, text=blue!40!black] {$c$} -- (cs.north);
% Orange: sigma -> right-angle into combined score bottom
\draw[orangearrow] (sigma.east) -- (sigma.east -| cs.south) node[pos=0.6, right, font=\scriptsize\itshape, text=orange!40!black] {$1 {-} \gamma \cdot \sigma_t$} -- (cs.south);
% ===================== DECISION =====================
