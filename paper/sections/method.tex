...
\begin{table}[t]
    ...
    \begin{tabular}{@{}ll@{}}
        ...
        $\epsilon$ & Quiet-to-Active transition rate ($\approx 0$; Active entered via forced injection) \\
        $a_D$ & Active-to-Decaying transition rate ($= 0.35$) \\
        $d_Q$ & Decaying-to-Quiet recovery rate ($= 0.18$) \\
