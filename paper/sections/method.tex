...
\draw[redarrow] (hmm) -- node[above, font=\tiny, text=red!70!black, yshift=2pt, align=center, scale=0.85]
...
\draw[redarrow] (sigma.north east) -- node[pos=0.4, below right, font=\scriptsize\itshape, text=red!70!black] {$1 {-} \gamma \cdot \sigma_t$} ([yshift=-3pt]cs.south west);
% ===================== DECISION =====================
