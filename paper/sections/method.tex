...
\draw[bluearrow] (pick.south east) -- node[pos=0.4, above right, font=\scriptsize\itshape, text=blue!40!black] {$c$} ([yshift=3pt]cs.north west);
% Orange: sigma -> straight diagonal to combined score
\draw[orangearrow] (sigma.north east) -- node[pos=0.4, below right, font=\scriptsize\itshape, text=orange!40!black] {$1 {-} \gamma \cdot \sigma_t$} ([yshift=-3pt]cs.south west);
% ===================== DECISION =====================
