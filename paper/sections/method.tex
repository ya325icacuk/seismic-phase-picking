...
\begin{tikzpicture}[
    % Blue stream styles
    blueinput/.style={draw=blue!50!black, fill=blue!4, rounded corners=4pt,
        minimum height=1cm, text=blue!50!black, font=\small, align=center},
    bluemodel/.style={draw=blue!50!black, fill=blue!12, rounded corners=4pt,
        minimum height=1.2cm, text=blue!50!black, font=\small, align=center,
        line width=0.8pt},
    % Orange stream styles (bottom stream)
    redinput/.style={draw=orange!50!black, fill=orange!6, rounded corners=4pt,
        minimum height=1cm, text=orange!50!black, font=\small, align=center},
    redmodel/.style={draw=orange!50!black, fill=orange!14, rounded corners=4pt,
        minimum height=1.2cm, text=orange!50!black, font=\small, align=center,
        line width=0.8pt},
    % Merge styles
    ...
    % Arrow styles
    bluearrow/.style={-{Stealth[length=5pt]}, blue!50!black, line width=0.7pt},
    orangearrow/.style={-{Stealth[length=5pt]}, orange!50!black, line width=0.7pt},
...
\draw[orangearrow] (hmm) -- node[above, font=\tiny, text=orange!50!black, yshift=2pt, align=center, scale=0.85]
    {$\pi_t(r)$\\[-1pt]regime posterior} (bb);
\draw[orangearrow] (bb) -- (sigma);
% ===================== STREAM LABELS =====================
\node[font=\footnotesize\bfseries, text=blue!50!black, anchor=west]
    at (seis.west |- {(0,4.2)}) {\textsc{Seismic Wave Detection Model}};
\node[font=\footnotesize\bfseries, text=orange!50!black, anchor=west]
...
\draw[bluearrow] (pick.south east) -- node[pos=0.4, above right, font=\scriptsize\itshape, text=blue!50!black] {$c$} ([yshift=3pt]cs.north west);
% Orange: sigma -> straight diagonal to combined score
\draw[orangearrow] (sigma.north east) -- node[pos=0.4, below right, font=\scriptsize\itshape, text=orange!50!black] {$1 {-} \gamma \cdot \sigma_t$} ([yshift=-3pt]cs.south west);
% ===================== DECISION =====================
